...
describe('ngb-datepicker', () => {
  ...
  it('should initialize inputs with provided config', () => {
    const defaultConfig: any = new NgbDatepickerConfig()
    const datepicker: any = TestBed.createComponent(NgbDatepicker).componentInstance
  ...
  it('should allow focusing datepicker programmatically', () => {
    const datepicker: any = TestBed.createComponent(NgbDatepicker)
  ...
  describe('ngModel', () => {
    ...
    it('should switch month on prev/next navigation click', async(() => {
         ...
         let dates: any = getDates(fixture.nativeElement)
         const navigation: any = getNavigationLinks(fixture.nativeElement)
  ...
  describe('Custom config', () => {
    ...
    it('should initialize inputs with provided config', () => {
      const fixture: any = TestBed.createComponent(NgbDatepicker)

      const datepicker: any = fixture.componentInstance
